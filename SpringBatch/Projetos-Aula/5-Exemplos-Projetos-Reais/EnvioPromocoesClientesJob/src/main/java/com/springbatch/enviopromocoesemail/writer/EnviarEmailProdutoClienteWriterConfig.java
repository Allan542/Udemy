...
public class EnviarEmailProdutoClienteWriterConfig {
    ...
    @Bean
    public SimpleMailMessageItemWriter enviarEmailProdutoClienteWriter(MailSender mailSender){ // Spring configura um bean do MailSender através das configurações que ele encontrou nas properties para um MailSender
