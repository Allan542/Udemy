...
public class FolhaPontoStepConfig {
	...
	public Step folhaPontoStep(
			...
			@Qualifier("imprimeFolhaPontoWriter") FlatFileItemWriter<FolhaPonto> folhaPontoTemplateWriter,
		...
		return stepBuilderFactory
				...
				.stream(folhaPontoTemplateWriter)
				.stream(folhaPontoInvalidoWriter)
				.build();
	}
}
