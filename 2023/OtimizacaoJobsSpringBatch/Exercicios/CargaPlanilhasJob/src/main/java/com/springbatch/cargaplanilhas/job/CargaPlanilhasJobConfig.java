...
public class CargaPlanilhasJobConfig {
	...
	public Job cargaPlanilahsJob(
		...
		return jobBuilderFactory
				...
				.start(cargaPlanilhasFlow(cargaClientesStep, cargaAcessosStep, cargaComprasStep, cargaDevolucoesStep))
				.end()
...
//				.next(cargaDevolucoesStep)
	...
	private Flow cargaPlanilhasFlow(Step cargaClientesStep, Step cargaAcessosStep, Step cargaComprasStep, Step cargaDevolucoesStep) {
		return new FlowBuilder<Flow>("cargaPlanilhasFlow")
			.split(new SimpleAsyncTaskExecutor())
			.add(
				cargaClientesFlow(cargaClientesStep),
				cargaAcessosFlow(cargaAcessosStep),
